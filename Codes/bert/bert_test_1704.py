...
data = pd.read_csv("LitCovid_20k.csv", index_col=0)
...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        abstract = self.data.iloc[idx]['abstract_lg']
...
model = BertForSequenceClassification.from_pretrained("bert-base-uncased", num_labels=len(data.topic.unique()))
